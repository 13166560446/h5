...
<div class="pages section">
    <div class="container">
        ...
        <div class="register">
            <div class="row">
                <form class="col s12" action="/index/reg" method="post">
                    ...
                    <div class="input-field">
                        <input type="password" placeholder="PASSWORD" class="validate" name="pass1" required>
                    </div>
                    <div class="input-field">
                        <input type="password" placeholder="CONFIRM PASSWORD" class="validate" name="pass2" required>
                    </div>
